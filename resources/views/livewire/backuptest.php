...
@endforelse
              ...
              @php
              $label=$label_names;
              $labelfirst_id=$label[0]["id"];
              $psettings_f=App\Models\lsetting::where('sub_id',$sub_id)->where ('book_id', $labelfirst_id)->get();
            
              $labelsec_id=$label[1]["id"];
              $psettings_s=App\Models\lsetting::where('sub_id',$sub_id)->where ('book_id', $labelsec_id)->get();
...
@foreach($psettings_f as $item)

<tr>
<td class="text-align-center">   </td> 
<td class="text-align-center">  {{$item->legal}}  </td>


      
                                                    <td class="text-align-center">
                                                        <button wire:click="#" style="    width: 72px;" class="btn btn-primary btn-xsm"><h6>Edit</h6></button>

                                                        <button wire:click="#" style="    width: 72px;" class="btn btn-danger "><h6>Delete</h6></button>
